...
На тактическом уровне, формирует [<abbr title="Objectives and key results">OKR</abbr>](goal-setting.md) и отслеживает их достижение, подбирает людей в команду, координирует её работу и управляет ресурсами.
